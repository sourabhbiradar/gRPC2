...
const (
	GreetService_GreetEveryone_FullMethodName = "/biDstream.GreetService/GreetEveryone"
)
...
func (x *greetServiceGreetEveryoneClient) Send(m *GreetReq) error {
	return x.ClientStream.SendMsg(m)
}

func (x *greetServiceGreetEveryoneClient) Recv() (*GreetResp, error) {
	m := new(GreetResp)
...
func (x *greetServiceGreetEveryoneServer) Send(m *GreetResp) error {
	return x.ServerStream.SendMsg(m)
}

func (x *greetServiceGreetEveryoneServer) Recv() (*GreetReq, error) {
	m := new(GreetReq)
...
var GreetService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "biDstream.GreetService",

...
const (
	SumService_Sum_FullMethodName = "/sumURPC.SumService/Sum"
)
...
type SumServiceClient interface {
	Sum(ctx context.Context, in *SumReqt, opts ...grpc.CallOption) (*SumResp, error)
}
...
func (c *sumServiceClient) Sum(ctx context.Context, in *SumReqt, opts ...grpc.CallOption) (*SumResp, error) {
	out := new(SumResp)
...
type SumServiceServer interface {
	Sum(context.Context, *SumReqt) (*SumResp, error)
...
func (UnimplementedSumServiceServer) Sum(context.Context, *SumReqt) (*SumResp, error) {
...
func _SumService_Sum_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SumServiceServer).Sum(ctx, req.(*SumReqt))
	}
...
var SumService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "sumURPC.SumService",

...
func (x *GreetReqt) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GreetReqt) ProtoMessage() {}

func (x *GreetReqt) ProtoReflect() protoreflect.Message {
	mi := &file_proto_greet_proto_msgTypes[0]
...
// Deprecated: Use GreetReqt.ProtoReflect.Descriptor instead.
func (*GreetReqt) Descriptor() ([]byte, []int) {
	return file_proto_greet_proto_rawDescGZIP(), []int{0}
}

func (x *GreetReqt) GetFirstName() string {
	if x != nil {
		return x.FirstName
	}
	return ""
...
func (x *GreetResp) GetReply() string {
	if x != nil {
		return x.Reply
	}
	return ""
...
var file_proto_greet_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x12, 0x09, 0x67, 0x72, 0x65, 0x65, 0x74, 0x47, 0x52, 0x50, 0x43, 0x22, 0x2a,
	0x0a, 0x09, 0x47, 0x72, 0x65, 0x65, 0x74, 0x52, 0x65, 0x71, 0x74, 0x12, 0x1d, 0x0a, 0x0a, 0x66,
	0x69, 0x72, 0x73, 0x74, 0x5f, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x09, 0x66, 0x69, 0x72, 0x73, 0x74, 0x4e, 0x61, 0x6d, 0x65, 0x22, 0x21, 0x0a, 0x09, 0x47, 0x72,
	0x65, 0x65, 0x74, 0x52, 0x65, 0x73, 0x70, 0x12, 0x14, 0x0a, 0x05, 0x72, 0x65, 0x70, 0x6c, 0x79,
	...
	0x05, 0x47, 0x72, 0x65, 0x65, 0x74, 0x12, 0x14, 0x2e, 0x67, 0x72, 0x65, 0x65, 0x74, 0x47, 0x52,
	0x50, 0x43, 0x2e, 0x47, 0x72, 0x65, 0x65, 0x74, 0x52, 0x65, 0x71, 0x74, 0x1a, 0x14, 0x2e, 0x67,
	0x72, 0x65, 0x65, 0x74, 0x47, 0x52, 0x50, 0x43, 0x2e, 0x47, 0x72, 0x65, 0x65, 0x74, 0x52, 0x65,
...
var file_proto_greet_proto_goTypes = []interface{}{
	(*GreetReqt)(nil), // 0: greetGRPC.GreetReqt
	(*GreetResp)(nil), // 1: greetGRPC.GreetResp
}
var file_proto_greet_proto_depIdxs = []int32{
	0, // 0: greetGRPC.GreetService.Greet:input_type -> greetGRPC.GreetReqt
	1, // 1: greetGRPC.GreetService.Greet:output_type -> greetGRPC.GreetResp

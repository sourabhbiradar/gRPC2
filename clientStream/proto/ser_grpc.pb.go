...
const (
	GreetService_LongGreet_FullMethodName = "/clientStream.GreetService/LongGreet"
)
...
func (c *greetServiceClient) LongGreet(ctx context.Context, opts ...grpc.CallOption) (GreetService_LongGreetClient, error) {
	stream, err := c.cc.NewStream(ctx, &GreetService_ServiceDesc.Streams[0], GreetService_LongGreet_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (x *greetServiceLongGreetClient) Send(m *GreetReq) error {
	return x.ClientStream.SendMsg(m)
}

func (x *greetServiceLongGreetClient) CloseAndRecv() (*GreetResp, error) {
...
func (x *greetServiceLongGreetServer) SendAndClose(m *GreetResp) error {
	return x.ServerStream.SendMsg(m)
}

func (x *greetServiceLongGreetServer) Recv() (*GreetReq, error) {
	m := new(GreetReq)
...
var GreetService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "clientStream.GreetService",
